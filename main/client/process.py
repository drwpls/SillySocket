...
class Process_Dialog(QtWidgets.QDialog):
    def __init__(self, sock):
        ...
        self.ValueTypeComboBox.move(10, 40)
        self.ValueTypeComboBox.addItems(['Name', 'PID'])
        self.ValueTypeComboBox.setFixedWidth(130)
        ...
        self.filterTextbox.move(10, 90)
        self.filterTextbox.setFixedWidth(130)

        self.filterButton = QtWidgets.QPushButton('Filter!', self.DirectModifyGr)
        self.filterButton.move(10, 130)
        self.filterButton.setFixedWidth(130)
        self.filterButton.setStyleSheet('color: green; font-weight: bold;')

        self.clearFilterButton = QtWidgets.QPushButton('Clear filter', self.DirectModifyGr)
        self.clearFilterButton.move(10, 170)
        self.clearFilterButton.setFixedWidth(130)
        self.clearFilterButton.setStyleSheet('color: red;')
